...
class Toplevel1:
    def __init__(self, top=None):
        ...
        def get():
            ...
            file = open("tts.txt", "w+", encoding='utf8')
            file.write(x)
            file.close()
            f= open("tts.txt", "r+", encoding='utf8')
            a = f.read()

            speech = gTTS(text=str(a), lang="hi", slow=False)
            speech.save("TTS.mp3")
        ...
        self.Label1.place(relx=0.1, rely=0.030, height=50, width=800)
        self.Label1.configure(background="pink")
        self.Label1.configure(disabledforeground="#a3a3a3")
        self.Label1.configure(foreground="black")
        self.Label1.configure(text='''Adaptive Technology Using Morse Code''', font=("arial", 30))
...
# speech = gTTS(text=encrypted_text, lang="hi", slow=False)
# speech.save("hindi.mp3")
# os.system("start hindi.mp3")
#
# self.Button3 = tk.Button(top)
# self.Button3.place(relx=0.5, rely=0.2, height=33, width=106)
# self.Button3.configure(activebackground="#ececec")
# self.Button3.configure(activeforeground="#000000")
# self.Button3.configure(background="#d9d9d9")
# self.Button3.configure(disabledforeground="#a3a3a3")
# self.Button3.configure(foreground="#000000")
# self.Button3.configure(highlightbackground="green")
# self.Button3.configure(highlightcolor="black")
# self.Button3.configure(pady="0")
# self.Button3.configure(text='''TTS''', command=tsh(x))
